...
const DetailPage = ({getDetails,match,detail,loading}) => {
    ...
    return (
     ...
     <div className='main-detail'> 
        <img src={detail.poster_path===null ? 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/No_image_3x4.svg/1200px-No_image_3x4.svg.png' :`http://image.tmdb.org/t/p/w220_and_h330_face/${detail.poster_path}`} alt={detail.title} className='center'/>
